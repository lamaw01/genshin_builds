...
class EngulfingLightning extends StatelessWidget {
  const EngulfingLightning({Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Image.asset(
                weaponPath + 'engulfing_lightning.png',
                width: 35.0,
                height: 35.0,
              ),
