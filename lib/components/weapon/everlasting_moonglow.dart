...
class EverlastingMoonglow extends StatelessWidget {
  const EverlastingMoonglow({Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Image.asset(
                weaponPath + 'everlasting_moonglow.png',
                width: 35.0,
                height: 35.0,
              ),
