...
class SnowTombedStarsilver extends StatelessWidget {
  const SnowTombedStarsilver({Key? key}) : super(key: key);
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              Image.asset(
                weaponPath + 'snow_tombed_starsilver.png',
                width: 35.0,
                height: 35.0,
              ),
              ...
              Column(
                ...
                children: [
                  ...
                  Text(
                    "BASE 565 substat Physical DMG Bonus 34.5%",
                    style: TextStyle(
                      fontSize: 9.sp,
